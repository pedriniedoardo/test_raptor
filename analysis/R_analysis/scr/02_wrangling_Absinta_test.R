...
df_counts <- readRDS("../../out/object/pseudobulk_all20_integrated_clean_metadata_counts_wholeSample_raw.rds") %>% 
  data.frame() %>% 
...
LUT_genes_full %>% 
  write_tsv("../../out/table/lUT_gene_full.tsv")
...
saveRDS(df_counts_full,"../../out/object/pseudobulk_all20_wholeSample_raw_filter_full.rds")
...
saveRDS(df_counts_full_ensembl,"../../out/object/pseudobulk_all20_wholeSample_raw_filter_ensembl.rds")
...
saveRDS(df_TPM,"../../out/object/pseudobulk_all20_wholeSample_TPM_filter_ensembl.rds")
