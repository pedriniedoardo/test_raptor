# AIM ---------------------------------------------------------------------
# with this alternative approach I am merging all the datasets are reference so they have all the same set of genes in the buildingo of the reference (not using Martina's samples)
